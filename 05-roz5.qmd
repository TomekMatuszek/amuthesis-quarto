...
Probabilities change significantly along with changes of near-infrared values, thus suggesting that this variable has greater impact on model predictions than thermal band.
...
For smaller towns, there is also higher thermal band's impact on model results for these areas but because of their small size, it is sometimes harder to capture.
