...
Creating correlation plot revealed, that some bands are highly correlated - especially these from visible spectrum and SWIR bands.
...
As a very basic way to check thermal band's importance on model's results, I implemented benchmarking methods with the help of functions provided by *mlr3* framework [@R-mlr3].
...
With cross-entropy loss value of 23, it was the least important variable in the dataset.
...
Probabilities change significantly along with changes of near-infrared values, thus suggesting that this variable has greater impact on model's predictions than thermal band.
