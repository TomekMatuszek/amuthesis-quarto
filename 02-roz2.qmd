...
On the dataset level, we can measure change in model's accuracy depending on presence of one specific variable.
This gives basic knowledge about this variable's impact on model predictions.
Assessing importance on instance level helps to understand impact of variables for one specific data point.
