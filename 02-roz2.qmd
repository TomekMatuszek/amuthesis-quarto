...
-   satellite images from Landsat programme downloaded using GLAD ARD software (raster data)

-   training points with information about land cover acquired from LUCAS programme (vector data)
