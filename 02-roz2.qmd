...
Visual representation of the workflow is shown in [@fig-rycina4].
...
Both datasets were downloaded for central-western part of Poland which was chosen as training area ([@fig-rycina1]).
...
It is based on interpreting partial-dependence (PD) profiles of variables ([@fig-rycina40]).
...
One way of calculating variable impact on the observation result is creating break-down plot ([@fig-rycina5]).
