...
These parameters can be fine-tuned to find values that give the best model accuracy.
...
Then, 10 models with different hyper-parameter values where created and trained.
