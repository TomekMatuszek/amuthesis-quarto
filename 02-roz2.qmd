...
All downloaded images were merged and reprojected from WGS 84 coordinate reference system (EPSG:4326) to UTM zone 33N (EPSG:32633).
...
Data collected during LUCAS field survey performed by Eurostat was chosen as land cover training set.
...
Comparison of these eleven models and original model made possible quantifying impact of every variable on original model results.
