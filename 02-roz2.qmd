...
Workflow of the study consisted of several stages: preprocessing of source data (described in Sections [-@sec-sat] and [-@sec-landcover]), creating training dataset, model's parameters tuning ([@sec-tuning]), land cover map prediction, model quality assessment ([@sec-resampling]) and evaluating the impact of the thermal band on the model's results ([@sec-importance]).
...
Example of such approach can be seen on [@fig-rycina5].
