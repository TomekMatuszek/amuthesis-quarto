...
{\centering \includegraphics[width=4in,height=8.48in]{./02-roz2_files/figure-latex/mermaid-figure-1.png}
...
Vegetation Index (NDVI; \textcite{tucker_red_1979}), Modified Normalized
Difference Water Index (MNDWI; \textcite{xu_modification_2006}),
Normalized Difference Moisture Index (NDMI;
\textcite{jin_comparison_2005}) and Modified Bare soil Index (MBI;
\textcite{nguyen_modified_2021}). Formulas used to calculate these
indices can be found in Table~\ref{tbl-tabela1}.
...
not as optimistic outcome as in other studies focused on this issue
...
More accurate land cover maps will help in better growth management of
