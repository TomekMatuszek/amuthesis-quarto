...
shown in Figure~\ref{fig-rycina4}.
...
(Figure~\ref{fig-rycina1}). This data was preprocessed and then used to
...
\caption{\label{fig-rycina1}Area covered by downloaded satellite
imagery}
...
such approach can be seen on Figure~\ref{fig-rycina7}.
...
profiles of variables (Figure~\ref{fig-rycina40}). Such type of plot
...
\caption{\label{fig-rycina40}Example variable profile for near-infrared
band (B5).}
...
\caption{\label{fig-rycina5}Example of a break-down plot that visualises
...
\caption{\label{fig-rycina8}Land cover map of Poznań metropolitan area
...
\caption{\label{fig-rycina9}Comparison of created land cover map with
RGB imagery.}
...
\caption{\label{fig-rycina10}Probability of chosen land cover class
...
\caption{\label{fig-rycina11}Variable profile for near-infrared band
(B5).}
...
\caption{\label{fig-rycina12}Variable profile for thermal band (B10)}
...
\caption{\label{fig-rycina13}Thermal band importance calculated for
...
\caption{\label{fig-rycina14}Thermal band importance interpolated from
