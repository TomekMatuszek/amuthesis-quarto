...
performance nested \emph{k}-fold cross-validation was performed. This
resulted with 2500 models created both on performance estimation level
and hyperparameter tuning level. Results of these models were then
evaluated and quality measures were calculated. In
...
needs some improvements. On the other hand, this performance is probably
enough to assess thermal band's importance
(Chapter~\ref{sec-results-therm}), which is the main goal of this study.
