...
and relatively high accuracy. Other advantages of this algorithm is
ability to handle missing values, wide spectrum of accepted variable
types (continuous, binary, categorical) and ease of modelling
high-dimensional data. \autocite{qi_random_2012} Random Forest consists
of specified number of decision trees, which are algorithms based on
