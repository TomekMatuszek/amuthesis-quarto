...
These parameters can be fine-tuned to find values that give the best
model accuracy. I chose three hyper-parameters for tuning: number of
trees, maximum depth of the forest and minimal size of each node in
...
\hypertarget{measuring-overall-variable-importance-and-its-spatial-distribution}{%
\section{Measuring overall variable importance and its spatial
distribution}\label{measuring-overall-variable-importance-and-its-spatial-distribution}}
