...
\hypertarget{sec-wyniki-mapa}{%
\chapter{Wynikowa mapa pokrycia terenu}\label{sec-wyniki-mapa}}
...
rozdziałach (Rozdziały \textbf{?@sec-lit}, \ref{sec-dane},
...
\hypertarget{sec-wyniki-ocena}{%
\chapter{Ocena jakości modelu klasyfikacyjnego}\label{sec-wyniki-ocena}}
...
\hypertarget{sec-wyniki-term}{%
\chapter{Ocena wpływu kanału termalnego na wyniki
klasyfikacji}\label{sec-wyniki-term}}
